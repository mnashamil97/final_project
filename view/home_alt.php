    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light p-2">
        ...
        <div class="collapse navbar-collapse order-1 order-md-0" id="navbarNav">
            <ul class="navbar-nav fw-bold">
                <li class="nav-item me-2">
                    <a href="#" class="text-decoration-underline" style="color:#808080">Home</a>
                </li>
                <li class="nav-item me-2">
                    <a href="#" class="text-decoration-underline" style="color:#808080">My Profile</a>
                </li>
                <li class="nav-item me-2">
                    <a href="#" class="text-decoration-underline" style="color:#808080">Contact Us</a>
                </li>
        ...
        <div>
            <span class="ps-2 me-2" style="color:#808080;">
                ...
                <span>Hi...! User</span> &nbsp;
                <a id="loginBtn" href="#" class="button btn border-0 text-white text-uppercase text-decoration-none" style="color:#808080;">
    ...
    <div class="container-fluid" id="newIn">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3 p-3">
                <a href="viewItem.php?productId=<?php //echo $maleProductsArray["product_id"]; 
                                                ?>" type="button" class="text-decoration-none text-muted w-100">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-3 p-3">
                <a href="viewItem.php?productId=<?php //echo $femaleProductsArray["product_id"]; 
                                                ?>" type="button" class="text-decoration-none text-muted w-100">
                    <div class="card shadow text-center">
                        <img style="height: 300px;" class="card-img-top zoom img-fluid" src="../image/pro_img/<?php ///echo $imageArray['img_name']; 
                                                                                                                ?>">
